...
class Player(object):
    def __init__(self, ping_sound):
        self.rect = pygame.Rect(int(SCREEN_WIDTH / 2), SCREEN_HEIGHT - 40, 5, 15)
...
class Enemy(object):
    def __init__(self, pong_sound):
        self.rect = pygame.Rect(int(SCREEN_WIDTH / 2), 25, 80, 15)
...
def main():
    ...
    pygame.display.set_caption("PingPong [ULTRA HARD]")
