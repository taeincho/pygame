...
class Player(object):
    def __init__(self, ping_sound):
        self.rect = pygame.Rect(int(SCREEN_WIDTH / 2), SCREEN_HEIGHT - 40, 800, 15)
...
class Enemy(object):
    def __init__(self, pong_sound):
        self.rect = pygame.Rect(int(SCREEN_WIDTH / 2), 25, 5, 15)
...
def main():
    ...
    pygame.display.set_caption("PingPong [EASY]")
